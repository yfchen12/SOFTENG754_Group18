...
public class CourseService {
    ...
    public List<Course> findAll() {
        ...
        String criteria = "You should have 2 years Java experience to enrol in this course. Please submit a CV or a link to personal profile as proof.";
        ...
        Course course6 = new Course("SOFTENG752", "Formal Specification and Design",
                "Course Outline",  courseValues , prerequisite, tels,
                20, Subject.ACADENG, CStatus.AVAILABLE, CourseCareer.CONTINUING_EDUCATION, "Class3",
                15, CourseComponent.LABORATORY, Campus.CITY, null, "",criteria);
